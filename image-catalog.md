...
- Συνολικές έννοιες: **282**
- Έννοιες που χρησιμοποιούνται στο Mode 5: **189**
- Συνολικές ειδικές εικόνες: **41**
- Ειδικές εικόνες μέσα στο Mode 5: **37**
- Έννοιες του Mode 5 που παραμένουν emoji: **152**
...
|---|---|---|---:|---|---|---|
| `boy` | Το αγόρι | 👦 | 17/33/37 | Emoji | Π3 | - |
| `girl` | Το κορίτσι | 👧 | 13/40/40 | Emoji | Π3 | - |
| `mom` | Η μαμά | 👩 | 11/19/21 | Emoji | Π3 | - |
| `dad` | Ο μπαμπάς | 👨 | 9/18/19 | Emoji | Π3 | - |
| `grandma` | Η γιαγιά | 👵 | 7/8/8 | Emoji | Π3 | - |
| `grandpa` | Ο παππούς | 👴 | 3/9/9 | Emoji | Π3 | - |
| `dog` | Ο σκύλος | 🐕 | 4/3/3 | Emoji | Π3 | - |
| `cat` | Η γάτα | 🐈 | 4/2/2 | Emoji | Π3 | - |
...
| `turtle` | Η χελώνα | 🐢 | 0/1/1 | Emoji | Π3 | - |
| `cow` | Η αγελάδα | 🐄 | 1/2/2 | Emoji | Π3 | - |
| `sheep` | Το πρόβατο | 🐑 | 0/1/1 | Emoji | Π3 | - |
| `horse` | Το άλογο | 🐴 | 2/2/2 | Emoji | Π3 | - |
| `teacherM` | Ο δάσκαλος | 👨‍🏫 | 2/3/3 | Emoji | Π3 | - |
| `teacherF` | Η δασκάλα | 👩‍🏫 | 4/6/6 | Emoji | Π3 | - |
| `doctor` | Ο γιατρός | 👨‍⚕️ | 0/1/1 | Emoji | Π3 | - |
| `nurse` | Η νοσοκόμα | 👩‍⚕️ | 0/1/1 | Emoji | Π3 | - |
| `cookM` | Ο μάγειρας | 👨‍🍳 | 2/1/1 | Emoji | Π3 | - |
| `cookF` | Η μαγείρισσα | 👩‍🍳 | 2/1/1 | Emoji | Π3 | - |
| `police` | Ο αστυνομικός | 👮 | 1/0/0 | Emoji | Π3 | - |
| `firefighter` | Ο πυροσβέστης | 👨‍🚒 | 1/0/0 | Emoji | Π3 | - |
| `gardener` | Ο κηπουρός | 🧑‍🌾 | 3/2/2 | Emoji | Π3 | - |
| `singer` | Η τραγουδίστρια | 👩‍🎤 | 0/1/1 | Emoji | Π3 | - |
...
| `pig` | Το γουρούνι | 🐖 | 0/1/1 | Emoji | Π3 | - |
...
| ID | Λέξη/φράση | Τωρινό οπτικό | Χρήση 3/4/5 | Κατάσταση | Προτεραιότητα | Αρχείο |
|---|---|---|---:|---|---|---|
| `eat` | τρώει | 🍽️ | 12/19/20 | Ειδική εικόνα | Έτοιμη | `assets/card-images/eat.png` |
| `drink` | πίνει | 🥤 | 9/13/14 | Ειδική εικόνα | Έτοιμη | `assets/card-images/drink.png` |
| `read` | διαβάζει | 📖 | 8/11/12 | Emoji | Π1 | - |
| `draw` | ζωγραφίζει | 🎨 | 7/6/6 | Emoji | Π1 | - |
| `hold` | κρατάει | 🤲 | 0/2/2 | Emoji | Π1 | - |
| `push` | σπρώχνει | ➡️ | 0/2/2 | Ειδική εικόνα | Έτοιμη | `assets/card-images/push.png` |
| `pull` | τραβάει | 🪢 | 0/2/2 | Emoji | Π1 | - |
| `throw` | πετάει | ⚽ | 0/2/2 | Ειδική εικόνα | Έτοιμη | `assets/card-images/throw.png` |
| `give` | δίνει | 🤲 | 0/6/6 | Ειδική εικόνα | Έτοιμη | `assets/card-images/give.png` |
| `take` | παίρνει | 🤲 | 0/4/4 | Ειδική εικόνα | Έτοιμη | `assets/card-images/take.png` |
| `see` | βλέπει | 👀 | 0/0/0 | Emoji | Αργότερα | - |
| `touch` | αγγίζει | 👆 | 0/0/0 | Emoji | Αργότερα | - |
| `wash` | πλένει | 🚰 | 0/5/5 | Ειδική εικόνα | Έτοιμη | `assets/card-images/wash.png` |
| `feed` | ταΐζει | 🍴 | 0/5/5 | Ειδική εικόνα | Έτοιμη | `assets/card-images/feed.png` |
| `cut` | κόβει | ✂️ | 0/5/6 | Emoji | Π1 | - |
| `open` | ανοίγει | 📦 | 0/7/8 | Ειδική εικόνα | Έτοιμη | `assets/card-images/open.png` |
| `make` | φτιάχνει | 🛠️ | 0/0/0 | Ειδική εικόνα | Έτοιμη | `assets/card-images/repair.png` |
| `hug` | αγκαλιάζει | 🫂 | 0/3/3 | Emoji | Π1 | - |
| `shout` | φωνάζει | 📢 | 4/0/0 | Emoji | Π3 | - |
| `search` | ψάχνει | 🔍 | 7/3/3 | Ειδική εικόνα | Έτοιμη | `assets/card-images/search.png` |
| `write` | γράφει | ✍️ | 7/7/7 | Emoji | Π1 | - |
| `plant` | φυτεύει | 🌱 | 4/3/3 | Ειδική εικόνα | Έτοιμη | `assets/card-images/plant.png` |
| `water` | ποτίζει | 🚿 | 4/3/3 | Ειδική εικόνα | Έτοιμη | `assets/card-images/water.png` |
| `collect` | μαζεύει | 🧺 | 4/1/1 | Emoji | Π1 | - |
| `wear` | φοράει | 🧢 | 0/4/4 | Ειδική εικόνα | Έτοιμη | `assets/card-images/wear.png` |
| `buy` | αγοράζει | 🛒 | 0/2/2 | Emoji | Π1 | - |
| `sell` | πουλάει | 🧾 | 0/0/0 | Emoji | Αργότερα | - |
| `cook` | μαγειρεύει | 👨‍🍳 | 5/3/4 | Ειδική εικόνα | Έτοιμη | `assets/card-images/cook.png` |
| `bake` | ψήνει | ♨️ | 4/3/3 | Emoji | Π1 | - |
| `play` | παίζει | 🧸 | 8/3/3 | Ειδική εικόνα | Έτοιμη | `assets/card-images/play.png` |
| `clean` | καθαρίζει | 🧽 | 5/5/5 | Ειδική εικόνα | Έτοιμη | `assets/card-images/clean.png` |
| `repair` | φτιάχνει | 🛠️ | 0/6/7 | Ειδική εικόνα | Έτοιμη | `assets/card-images/repair.png` |
| `carry` | κουβαλάει | 💪 | 0/2/2 | Ειδική εικόνα | Έτοιμη | `assets/card-images/carry.png` |
| `hide` | κρύβει | 🙈 | 0/1/1 | Emoji | Π1 | - |
| `find` | βρίσκει | ✅ | 0/4/4 | Ειδική εικόνα | Έτοιμη | `assets/card-images/find.png` |
| `use` | χρησιμοποιεί | 🛠️ | 0/8/8 | Emoji | Π1 | - |
| `close` | κλείνει | 🔒 | 0/3/3 | Emoji | Π1 | - |
| `fill` | γεμίζει | 🫗 | 0/1/1 | Emoji | Π1 | - |
| `empty` | αδειάζει | 🪣 | 0/1/1 | Emoji | Π1 | - |
| `photograph` | φωτογραφίζει | 📷 | 0/2/2 | Emoji | Π1 | - |

### ΤΙ

| ID | Λέξη/φράση | Τωρινό οπτικό | Χρήση 3/4/5 | Κατάσταση | Προτεραιότητα | Αρχείο |
|---|---|---|---:|---|---|---|
| `apple` | το μήλο | 🍎 | 0/7/8 | Emoji | Π2 | - |
| `banana` | την μπανάνα | 🍌 | 0/3/3 | Emoji | Π2 | - |
| `bread` | το ψωμί | 🍞 | 0/5/5 | Emoji | Π2 | - |
| `milk` | το γάλα | 🥛 | 0/4/4 | Emoji | Π2 | - |
| `water` | το νερό | 💧 | 0/10/11 | Emoji | Π2 | - |
| `ball` | την μπάλα | ⚽ | 0/6/6 | Emoji | Π2 | - |
| `carToy` | το αυτοκίνητο | 🚗 | 0/1/1 | Emoji | Π2 | - |
| `doll` | την κούκλα | 🪆 | 0/2/2 | Emoji | Π2 | - |
| `book` | το βιβλίο | 📚 | 0/12/13 | Emoji | Π2 | - |
| `pencil` | το μολύβι | ✏️ | 0/4/4 | Emoji | Π2 | - |
| `papers` | τα χαρτιά | 📄 | 0/0/0 | Emoji | Αργότερα | - |
| `chair` | την καρέκλα | 🪑 | 0/3/3 | Emoji | Π2 | - |
| `flower` | το λουλούδι | 🌸 | 0/9/9 | Emoji | Π2 | - |
| `tree` | το δέντρο | 🌳 | 0/2/2 | Emoji | Π2 | - |
| `hat` | το καπέλο | 🎩 | 0/2/2 | Emoji | Π2 | - |
| `shoe` | το παπούτσι | 👟 | 0/0/0 | Emoji | Αργότερα | - |
| `bag` | την τσάντα | 👜 | 0/3/3 | Emoji | Π2 | - |
| `key` | το κλειδί | 🔑 | 0/5/5 | Emoji | Π2 | - |
| `gift` | το δώρο | 🎁 | 0/3/4 | Emoji | Π2 | - |
| `cake` | την τούρτα | 🎂 | 0/6/6 | Emoji | Π2 | - |
| `star` | το αστέρι | ⭐ | 0/2/2 | Emoji | Π2 | - |
| `glass` | το ποτήρι | 🥤 | 0/2/2 | Emoji | Π2 | - |
| `plate` | το πιάτο | 🍽️ | 0/1/1 | Emoji | Π2 | - |
| `spoon` | το κουτάλι | 🥄 | 0/0/0 | Emoji | Αργότερα | - |
| `fork` | το πιρούνι | 🍴 | 0/0/0 | Ειδική εικόνα | Έτοιμη | `assets/card-images/fork.png` |
| `toothbrush` | την οδοντόβουρτσα | 🪥 | 0/2/2 | Emoji | Π2 | - |
| `soap` | το σαπούνι | 🧼 | 0/0/0 | Emoji | Αργότερα | - |
| `umbrella` | την ομπρέλα | ☂️ | 0/8/8 | Emoji | Π2 | - |
| `puzzle` | το παζλ | 🧩 | 0/0/0 | Emoji | Αργότερα | - |
| `toy` | το παιχνίδι | 🧩 | 0/4/4 | Ειδική εικόνα | Έτοιμη | `assets/card-images/toy.png` |
| `drum` | το τύμπανο | 🥁 | 0/1/1 | Emoji | Π2 | - |
| `guitar` | την κιθάρα | 🎸 | 0/1/1 | Emoji | Π2 | - |
| `phone` | το τηλέφωνο | 📱 | 0/5/5 | Emoji | Π2 | - |
| `computer` | τον υπολογιστή | 💻 | 0/2/2 | Emoji | Π2 | - |
| `bike` | το ποδήλατο | 🚲 | 0/4/5 | Emoji | Π2 | - |
| `box` | το κουτί | 📦 | 0/4/4 | Emoji | Π2 | - |
| `carrot` | το καρότο | 🥕 | 0/6/7 | Emoji | Π2 | - |
| `iceCream` | το παγωτό | 🍦 | 0/0/0 | Emoji | Αργότερα | - |
| `pizza` | την πίτσα | 🍕 | 0/1/1 | Emoji | Π2 | - |
| `letter` | το γράμμα | ✉️ | 0/5/5 | Emoji | Π2 | - |
| `name` | το όνομα | 🔤 | 0/4/4 | Emoji | Π2 | - |
| `exercise` | την άσκηση | 📝 | 0/0/0 | Emoji | Αργότερα | - |
| `list` | τη λίστα | 📋 | 0/1/1 | Emoji | Π2 | - |
| `soup` | τη σούπα | 🍲 | 0/1/2 | Emoji | Π2 | - |
| `pasta` | τα μακαρόνια | 🍝 | 0/1/1 | Emoji | Π2 | - |
| `vegetables` | τα λαχανικά | 🥦 | 0/1/1 | Emoji | Π2 | - |
| `lettuce` | το μαρούλι | 🥬 | 0/1/1 | Emoji | Π2 | - |
| `grass` | το χορτάρι | 🌿 | 0/2/2 | Emoji | Π2 | - |
| `fishMeal` | το ψάρι | 🐟 | 0/1/1 | Emoji | Π2 | - |
| `petFood` | την τροφή | 🥣 | 0/1/1 | Emoji | Π2 | - |
| `shoes` | τα παπούτσια | 👟 | 0/2/2 | Emoji | Π2 | - |
| `boardGame` | το επιτραπέζιο παιχνίδι | 🎲 | 0/1/1 | Emoji | Π2 | - |
| `dogObject` | τον σκύλο | 🐕 | 0/2/2 | Emoji | Π2 | - |
| `henObject` | την κότα | 🐔 | 0/2/2 | Emoji | Π2 | - |
| `momObject` | τη μαμά | 👩 | 0/1/1 | Emoji | Π2 | - |
| `dadObject` | τον μπαμπά | 👨 | 0/1/1 | Emoji | Π2 | - |

### ΠΟΥ

| ID | Λέξη/φράση | Τωρινό οπτικό | Χρήση 3/4/5 | Κατάσταση | Προτεραιότητα | Αρχείο |
|---|---|---|---:|---|---|---|
| `home` | στο σπίτι | 🏠 | 16/47/49 | Ειδική εικόνα | Έτοιμη | `assets/card-images/home.png` |
| `park` | στο πάρκο | 🌳 | 3/6/7 | Ειδική εικόνα | Έτοιμη | `assets/card-images/park.png` |
| `school` | στο σχολείο | 🏫 | 9/11/12 | Emoji | Π1 | - |
| `beach` | στην παραλία | 🏖️ | 0/3/3 | Emoji | Π1 | - |
| `garden` | στον κήπο | 🌷 | 8/11/11 | Emoji | Π1 | - |
| `kitchen` | στην κουζίνα | 🍳 | 10/15/17 | Ειδική εικόνα | Έτοιμη | `assets/card-images/kitchen.png` |
| `bathroom` | στο μπάνιο | 🛁 | 0/2/2 | Emoji | Π1 | - |
| `car` | στο αυτοκίνητο | 🚗 | 0/0/0 | Emoji | Αργότερα | - |
| `table` | στο τραπέζι | 🍽️ | 4/3/3 | Ειδική εικόνα | Έτοιμη | `assets/card-images/table.png` |
| `bed` | στο κρεβάτι | 🛌 | 1/2/2 | Emoji | Π1 | - |
| `floor` | στο πάτωμα | 🟫 | 0/2/2 | Emoji | Π1 | - |
| `playground` | στην παιδική χαρά | 🛝 | 2/3/3 | Emoji | Π1 | - |
...
| `zoo` | στον ζωολογικό κήπο | 🦒 | 1/1/1 | Emoji | Π1 | - |
| `pharmacy` | στο φαρμακείο | 💊 | 0/0/0 | Emoji | Αργότερα | - |
| `restaurant` | στο εστιατόριο | 🍴 | 3/2/2 | Ειδική εικόνα | Έτοιμη | `assets/card-images/restaurant.png` |
| `stadium` | στο γήπεδο | 🏟️ | 1/0/0 | Emoji | Π3 | - |
| `library` | στη βιβλιοθήκη | 🏛️ | 1/2/2 | Ειδική εικόνα | Έτοιμη | `assets/card-images/library.png` |
| `clinic` | στο ιατρείο | 🩺 | 0/1/1 | Emoji | Π1 | - |
| `livingRoom` | στο σαλόνι | 🛋️ | 3/0/0 | Emoji | Π3 | - |
| `bedroom` | στο υπνοδωμάτιο | 🛏️ | 0/0/0 | Emoji | Αργότερα | - |
| `classroom` | στην τάξη | 🧑‍🏫 | 9/18/18 | Ειδική εικόνα | Έτοιμη | `assets/card-images/classroom.png` |
| `bus` | στο λεωφορείο | 🚌 | 0/0/0 | Emoji | Αργότερα | - |
| `station` | στον σταθμό | 🚉 | 0/0/0 | Emoji | Αργότερα | - |
| `bakery` | στον φούρνο | 🥖 | 1/2/2 | Emoji | Π1 | - |
...
| `farm` | στη φάρμα | 🚜 | 4/8/8 | Emoji | Π1 | - |
| `dentist` | στο οδοντιατρείο | 🦷 | 0/0/0 | Emoji | Αργότερα | - |
| `office` | στο γραφείο | 🖥️ | 2/4/4 | Emoji | Π1 | - |
| `yard` | στην αυλή | 🏡 | 9/11/12 | Ειδική εικόνα | Έτοιμη | `assets/card-images/yard.png` |
| `postOffice` | στο ταχυδρομείο | 📮 | 0/0/0 | Emoji | Αργότερα | - |
| `musicRoom` | στην αίθουσα μουσικής | 🎹 | 1/2/2 | Emoji | Π1 | - |
...
| `showMomBoy` | γιατί θέλει να το δείξει στη μαμά του | 👉 | 0/0/1 | Emoji | Π1 | - |
| `showMomGirl` | γιατί θέλει να το δείξει στη μαμά της | 👉 | 0/0/1 | Emoji | Π1 | - |
...
| `tooFull` | γιατί γέμισε πολύ | 🪣 | 0/0/0 | Emoji | Αργότερα | - |
...
| `boxDirty` | γιατί το κουτί είναι βρόμικο | 📦 | 0/0/1 | Emoji | Π1 | - |
...
| `lovesMomBoy` | γιατί αγαπάει τη μαμά του | ❤️ | 0/0/1 | Emoji | Π1 | - |
| `lovesDadGirl` | γιατί αγαπάει τον μπαμπά της | ❤️ | 0/0/1 | Emoji | Π1 | - |
