...
- Έννοιες που χρησιμοποιούνται στο Mode 5: **188**
- Συνολικές ειδικές εικόνες: **41**
- Ειδικές εικόνες μέσα στο Mode 5: **37**
- Έννοιες του Mode 5 που παραμένουν emoji: **151**
...
| `carefulLook` | γιατί κοιτάζει προσεκτικά | 🔎 | 0/0/1 | Emoji | Π1 | - |
...
| `searchedEverywhere` | γιατί έψαξε παντού | 🔍 | 0/0/3 | Emoji | Π1 | - |
