...
Η πλήρης χειροκίνητη λίστα των 140 εγκεκριμένων προτάσεων για το Mode 5 βρίσκεται στο `mode5-sentence-bank.md`. Τα Modes 3 και 4 χρησιμοποιούν επίσης ελεγμένα sentence banks και δεν παράγουν ελεύθερους συνδυασμούς.
