...
- Mode 3: ΠΟΙΟΣ + ΤΙ ΚΑΝΕΙ + ΠΟΥ
- Mode 4: ΠΟΙΟΣ + ΤΙ ΚΑΝΕΙ + ΤΙ + ΠΟΥ
- Mode 5: ΠΟΙΟΣ + ΤΙ ΚΑΝΕΙ + ΤΙ + ΠΟΥ + ΓΙΑΤΙ

Η πλήρης χειροκίνητη λίστα των 164 εγκεκριμένων προτάσεων για το Mode 5 βρίσκεται στο `mode5-sentence-bank.md`. Τα Modes 3 και 4 χρησιμοποιούν επίσης ελεγμένα sentence banks και δεν παράγουν ελεύθερους συνδυασμούς.
...
80. 📝 **γιατί της έβαλε άσκηση η δασκάλα** `teacherExerciseGirl`
...
88. 📦 **γιατί το κουτί είναι βρόμικο** `boxDirty`
...
97. 🔑 **γιατί το είχε χάσει** `hadLostIt`
...
103. ❤️ **γιατί αγαπάει τη μαμά του** `lovesMomBoy`
104. ❤️ **γιατί αγαπάει τον μπαμπά της** `lovesDadGirl`
